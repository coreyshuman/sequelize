...
module.exports = function (BaseTypes) {
  ...
  // Tedious returns Date object for TIME.
  // Convert to HH:mm:ss format to match other dialects.
  var TIME = BaseTypes.TIME.inherits();

  TIME.parse = function (value, options) {
    if(!(value instanceof Date)) return value;

    value = moment(value).tz('UTC').format('HH:mm:ss');
    return value;
  };
